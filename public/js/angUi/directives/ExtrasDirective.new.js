app.directive("extrasForm",function($compile, $rootScope, dashboard){
    return{
        restrict: 'E',
        replace: true,
        ...
        link: function(scope, elem, attrs){
            ...
            scope.addExtraChargeToList = function(){
                if(scope.chargeType.idextras != null & scope.extrasQuantity != null){
                    for(var i = 0; i < scope.extrasQuantity; i++){
            ...
            scope.removeRow  = function(array, index){
                dashboard.deleteExtraCharge(array[index].idreservationextras)
                    .then(function(data){
                      scope.getExtrasForReservation();
                    })
                    .catch(function(err){
