<div layout="row" flex>
  <div>
    ...
    <md-date-range-picker first-day-of-week="0" selected-template="calendarModel.selectedTemplate" selected-template-name="calendarModel.selectedTemplateName"
      show-template="true" date-start="calendarModel.dateStart" date-end="calendarModel.dateEnd"></md-date-range-picker>
    <h2>One Panel</h2>
    <md-date-range-picker first-day-of-week="0" selected-template="calendarModel.selectedTemplate" selected-template-name="calendarModel.selectedTemplateName"
      show-template="true" date-start="calendarModel.dateStart" date-end="calendarModel.dateEnd" one-panel="true"></md-date-range-picker>
  </div>
